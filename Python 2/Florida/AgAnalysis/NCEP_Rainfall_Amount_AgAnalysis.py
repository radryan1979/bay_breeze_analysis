...
for cst in ["EC_SB","WC_SB","BC_SB","Non_SB"]:#
    ...
    if ag_analysis:
        ...
        print("{0} days make up {1} of total days.\n The percent of daytime precipitation on {0} days is {2}.".format(cst,len(dates)/1012.0*100,perc_ag_precip))
    ...
    if ag_analysis:
        ...
        plt.savefig("/Volumes/LaCie/SeaBreeze/Florida/StationDetection/Results3_6_19/Figures/AgPrecip15Hr/SBC_PoP_{0}_Classic.png".format(cst), 
            dpi=500)
        plt.show()
        ...
        ax.add_feature(coast, linestyle="-", edgecolor="darkslategray", linewidth=1)
        ax.set(xlim=(-83.75,-79.75),ylim=(24.4,30.5))
        plt.savefig("/Volumes/LaCie/SeaBreeze/Florida/StationDetection/Results3_6_19/Figures/AgPrecip15Hr/{0}_PrecipAccum.png".format(cst),
            dpi=500)
        plt.show()
        ...
        ax.add_feature(coast, linestyle="-", edgecolor="darkslategray", linewidth=1)
        ax.set(xlim=(-83.75,-79.75),ylim=(24.4,30.5))
        plt.savefig("/Volumes/LaCie/SeaBreeze/Florida/StationDetection/Results3_6_19/Figures/AgPrecip15Hr/{0}_Classic_PercentPrecip.png".format(cst),
            dpi=500)
        plt.show()
        ...
        plt.xlim(0)
        plt.savefig("/Volumes/LaCie/SeaBreeze/Florida/StationDetection/Results3_6_19/Figures/AgPrecip15Hr/DailyPrecip_{0}_Distribution.png".format(cst),
            dpi=500)
        plt.show()
