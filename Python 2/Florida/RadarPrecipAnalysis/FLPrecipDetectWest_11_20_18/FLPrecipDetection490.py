...
workingdir = "/home/1898/FLPrecip/2013_2017West/490/"

#Ingest date file:
df = pd.read_csv(workingdir+'HughesWestTimes490.csv')
...
for i in df.index:
    ...
    if date.month == mo:
        ...
        mo_df.to_csv(workingdir+"{0}_{1}_RefBins.csv".format(mo,date.year))
