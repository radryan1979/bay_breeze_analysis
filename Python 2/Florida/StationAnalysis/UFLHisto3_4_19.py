...
path_name="/Volumes/LaCie/SeaBreeze/Florida/StationDetection/Results3_4_19/"
suffix="Hughes.csv"
...
for ty in types:
    for i in range(2):
        ...
        plt.xlim(0)
        plt.savefig(path_name+"/Figures/Histograms/{0}Coast/12HrPrecip_{1}.png".format(coast,ty),dpi=1200)
        plt.show()
        ...
        plt.text((bins.max()-bins.min())/4.0, (n1.max()-n1.min())/3.0, u'$\u03bc_b$=%(mu)2.2f\N{DEGREE SIGN}, \n$MAD_b$=%(MAD)2.2f\N{DEGREE SIGN}' %\
                 {'mu':temp_df['WDBefore'].mean(),'MAD':temp_df['WDBefore'].mad()})
        plt.text((bins.max()-bins.min())/4.0, (n1.max()-n1.min())/6.0, u'$\u03bc_a$=%(mu)2.2f\N{DEGREE SIGN}, \n$MAD_a$=%(MAD)2.2f\N{DEGREE SIGN}' %\
                 {'mu':temp_df['WDAfter'].mean(),'MAD':temp_df['WDAfter'].mad()})
        plt.xlim(0)
        plt.savefig(path_name+"/Figures/Histograms/{0}Coast/WindDir_{1}.png".format(coast,ty),dpi=1200)
        plt.show()
        ...
        plt.xlim(0,180)
        # plt.savefig(path_name+"/Figures/Histograms/{0}Coast/WSChange_{1}.png".format(coast,ty),dpi=1200)
        plt.show()
        ...
        plt.xlim(0)
        # plt.savefig(path_name+"/Figures/Histograms/{0}Coast/TempChange_{2}.png".format(coast,ty),dpi=1200)
        plt.show()
        """
        ...
        plt.xlim(0)
        plt.savefig(path_name+"/Figures/Histograms/{0}Coast/WS_{1}.png".format(coast,ty),dpi=1200)
        plt.show()
        ...
        plt.xlim(0)
        plt.savefig(path_name+"/Figures//Histograms/{0}Coast/SBF_Timing_{1}.png".format(coast,ty),dpi=1200)
        plt.show()
        
        
        #Relative Humidity before and after sea breeze passage
        bins = np.linspace(6, 31, 30)
        y=temp_df['DPTempBefore'].dropna()
        ...
        plt.text((bins.max()-bins.min())/4.0, (n1.max()-n1.min())/3.0, u'$\u03bc_b$=%(mu)2.2f, \n$MAD_b$=%(MAD)2.2f' %\
                 {'mu':temp_df['DPTempBefore'].mean(),'MAD':temp_df['DPTempBefore'].mad()})
        plt.text((bins.max()-bins.min())/4.0, (n1.max()-n1.min())/6.0, u'$\u03bc_a$=%(mu)2.2f, \n$MAD_a$=%(MAD)2.2f' %\
                 {'mu':temp_df['DPTempAfter'].mean(),'MAD':temp_df['DPTempAfter'].mad()})
        plt.xlim(6)
        plt.savefig(path_name+"/Figures/Histograms/{0}Coast/RH_{1}.png".format(coast,ty),dpi=1200)
        plt.show()
        ...
        plt.xlim(0)
        plt.savefig(path_name+"/Figures/Histograms/{0}Coast/Temp_{1}.png".format(coast,ty),dpi=1200)
        plt.show()
