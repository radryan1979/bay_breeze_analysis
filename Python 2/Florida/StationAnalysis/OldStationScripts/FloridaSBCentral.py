...
for station in Station_list: #Loop through years of interest
    ...
    ***********************************************
    ...
    newdf.to_csv(os.path.join("/Volumes/LaCie/SeaBreeze/Florida/FinalFlorida/EastCoast/"\
    ...
    timedf.to_csv(os.path.join("/Volumes/LaCie/SeaBreeze/Florida/FinalFlorida/EastCoast/"\
