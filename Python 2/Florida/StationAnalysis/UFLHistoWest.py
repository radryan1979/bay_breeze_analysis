...
plt.xlabel('Precipitation [mm]')
plt.ylabel('Frequency')
plt.title('Hughes Algorithm Florida West Coast')
plt.text(30, 1250, u'\u03bc=%(mu)2.2f mm, \nMAD=%(MAD)2.2f mm' %\
         {'mu':df['TwelveHrPrecip'].mean(),'MAD':df['TwelveHrPrecip'].mad()})
plt.xlim(0)
plt.savefig(path_name+"/Histograms/12HrPrecipWest.png",dpi=1200)
plt.show()
...
plt.ylabel('Frequency')
plt.title('Hughes Algorithm Florida West Coast')
plt.text(10, 250, u'$\u03bc_b$=%(mu)2.2f\N{DEGREE SIGN}, \n$MAD_b$=%(MAD)2.2f\N{DEGREE SIGN}' %\
         {'mu':df['WDBefore'].mean(),'MAD':df['WDBefore'].mad()})
plt.text(10, 200, u'$\u03bc_a$=%(mu)2.2f\N{DEGREE SIGN}, \n$MAD_a$=%(MAD)2.2f\N{DEGREE SIGN}' %\
         {'mu':df['WDAfter'].mean(),'MAD':df['WDAfter'].mad()})
plt.xlim(0)
plt.savefig(path_name+"/Histograms/WDWest.png",dpi=1200)
plt.show()
...
plt.ylabel('Frequency')
plt.title('Hughes Algorithm Florida West Coast')
plt.text(0.25, 110, u'$\u03bc_b$=%(mu)2.2f mi $hr^-$$^1$, \n$MAD_b$=%(MAD)2.2fmi $hr^-$$^1$' %\
         {'mu':df['WSBefore'].mean(),'MAD':df['WSBefore'].mad()})
plt.text(0.25, 75, u'$\u03bc_a$=%(mu)2.2f mi $hr^-$$^1$, \n$MAD_a$=%(MAD)2.2fmi $hr^-$$^1$' %\
         {'mu':df['WSAfter'].mean(),'MAD':df['WSAfter'].mad()})
plt.xlim(0)
plt.savefig(path_name+"/Histograms/WSWest.png",dpi=1200)
plt.show()
...
plt.xlim(0)
plt.savefig(path_name+"/Histograms/SBFTimingWest.png",dpi=1200)
plt.show()
...
plt.ylabel('Frequency')
plt.title('Hughes Algorithm Florida West Coast')
plt.text(42, 275, u'$\u03bc_b$=%(mu)2.2f, \n$MAD_b$=%(MAD)2.2f' %\
         {'mu':df['RHBefore'].mean(),'MAD':df['RHBefore'].mad()})
plt.text(42, 190, u'$\u03bc_a$=%(mu)2.2f, \n$MAD_a$=%(MAD)2.2f' %\
         {'mu':df['RHAfter'].mean(),'MAD':df['RHAfter'].mad()})
plt.xlim(40)
plt.savefig(path_name+"/Histograms/RHWest.png",dpi=1200)
plt.show()
...
plt.ylabel('Frequency')
plt.title('Hughes Algorithm Florida West Coast')
plt.text(12, 400, u'$\u03bc_b$=%(mu)2.2f\N{DEGREE SIGN}C, \n$MAD_b$=%(MAD)2.2f\N{DEGREE SIGN}C' %\
         {'mu':df['TBefore'].mean(),'MAD':df['TBefore'].mad()})
plt.text(12, 200, u'$\u03bc_a$=%(mu)2.2f\N{DEGREE SIGN}C, \n$MAD_a$=%(MAD)2.2f\N{DEGREE SIGN}C' %\
         {'mu':df['TAfter'].mean(),'MAD':df['TAfter'].mad()})
plt.xlim(10)
plt.savefig(path_name+"/Histograms/TempWest.png",dpi=1200)
plt.show()
...
for i in range(4,11):
    ...
    plt.ylabel('Frequency')
    plt.title('West Hughes Algorithm Florida East Coast \nSST Month: {0}'.format(i))
    ...
    # plt.xlim(0)
    plt.savefig(path_name+"/Histograms/WestCoastSBC_SST/WestSBC_SSTEast_{0}.png".format(i),dpi=500)
    plt.show()
...
for i in range(4,11):
    ...
    plt.xlabel('SST [\N{DEGREE SIGN}C]')
    plt.ylabel('Frequency')
    plt.title('West Hughes Algorithm Florida West Coast \nSST Month: {0}'.format(i))
    plt.text(20, 20, u'\u03bc=%(mu)2.2f\N{DEGREE SIGN}C, \nMAD=%(MAD)2.2f\N{DEGREE SIGN}C' %\
             {'mu':df.loc[df["Date"].dt.month==i]["SST_West"].mean(),\
             'MAD':df.loc[df["Date"].dt.month==i]["SST_West"].mad()})
    # plt.xlim(0)
    plt.savefig(path_name+"/Histograms/WestCoastSBC_SST/WestSBC_SSTWest_{0}.png".format(i),dpi=500)
    plt.show()
...
for i in range(4,11):
    ...
    plt.xlabel('SST [\N{DEGREE SIGN}C]')
    plt.ylabel('Frequency')
    plt.title('West Hughes Algorithm Florida South Coast \nInside Keys SST Month: {0}'.format(i))
    plt.text(20, 20, u'\u03bc=%(mu)2.2f\N{DEGREE SIGN}C, \nMAD=%(MAD)2.2f\N{DEGREE SIGN}C' %\
             {'mu':df.loc[df["Date"].dt.month==i]["SST_South_InsideKeys"].mean(),\
             'MAD':df.loc[df["Date"].dt.month==i]["SST_South_InsideKeys"].mad()})
    # plt.xlim(0)
    plt.savefig(path_name+"/Histograms/WestCoastSBC_SST/WestSBC_SSTSouthInsideKeys_{0}.png".format(i),dpi=500)
    plt.show()
...
for i in range(4,11):
    ...
    # plt.xlim(0)
    plt.savefig(path_name+"/Histograms/WestCoastSBC_SST/WestSBC_SSTSouthOutsideKeys_{0}.png".format(i),dpi=500)
    plt.show()
