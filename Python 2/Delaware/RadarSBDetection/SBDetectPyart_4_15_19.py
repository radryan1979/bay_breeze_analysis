...
def sb_day_analysis(rs, date):
    ...
    ###########################################################################
        ...
        if lons.max()>100.0 or lats.max()>100.0:
...
w_dir = "/home/1898/RadSBDetect/SBDetect4_15_19/"
...
total_df.to_csv(w_dir+"2013_2018RadarDetect.csv")
