...
def sb_day_analysis(rs, date):
    ...
    # plot_sbf(timestamp, og_gref, og_glon, og_glat,"plot1")
    ...
    plot_sbf(timestamp, gref, glon, glat, "plot3", sbf)
...
def plot_sbf(date, gref, glon, glat, title, sbf=()):
    ...
    plt.savefig(w_dir+'{0}.png'.format(title),transparent=True)
    return
