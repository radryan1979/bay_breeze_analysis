...
def sb_day_analysis(rs, date):
    ...
    ###########################################################################
        ...
        float(np.count_nonzero(unmasked)) >= 0.15:
...
def connected_areas(gref2):
    ...
    for i in range(len(areas)):
        ...
        comp_ratio = 1.2732*areas[i]/float(maj_ax_len[i])**2
        
        if areas[i]>100 and means[i]>22.0:
        ...
        if areas[i]>750 and comp_ratio<0.45 and means[i]<22.0:
...
loref = 6.0; hiref = 25.0 #dBz thresholds
...
w_dir = "/home/1898/RadSBDetect/SBDetect/"
