...
def sb_day_analysis(rs, date):
    ...
    ###########################################################################
        ...
        plot_sbf(date, gref, glon, glat, sbf, timestamp)
...
def plot_sbf(date, gref, glon, glat, sbf, time):
    ...
    plt.savefig('/home/1898/RadSBDetect/Test_11_21_18/{0}_{1}_{2}_{3}_{4}Image.png'.\
    format(day,mo,yr,hr,mn))
    return
...
w_dir = "/home/1898/RadSBDetect/Test_11_21_18/"
